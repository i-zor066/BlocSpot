...
public class MapSearchResults extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    public boolean onMarkerClick(Marker marker) {
        ...
        pointOfInterestClicked = new PointOfInterest(-1, marker.getTitle(), marker.getSnippet(),(float) marker.getPosition().latitude, (float) marker.getPosition().longitude, "Unsorted", "notSetYet", false);
