...
public class PointOfInterest implements Parcelable {
    ...
    public PointOfInterest(long rowId, String title, String address, float latitude, float longitude, String poiCategory, String poiNote, boolean visited) {
