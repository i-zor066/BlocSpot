...
public class MapPane extends Activity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        color = BlocSpotApplication.getSharedDataSource().getCategoryFromDBWithCategoryName(categoryName).getColor();
    ...
    public void onMapReady(GoogleMap map) {
        ...
        map.addMarker(new MarkerOptions()
                ...
                .title(title)
                .snippet(address)
                .icon(BitmapDescriptorFactory.defaultMarker(colorH)))
                .showInfoWindow();
